...
if __name__ == "__main__":
    ...
    # LogCompletionsCallback generates from a "prompt" column, so only attach it when the eval
    # dataset has one. Conversational ("messages") datasets do not, and would otherwise crash the
    # eval step; eval loss is still computed without the callback.
